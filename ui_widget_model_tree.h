...
public:
    ...
    void setupUi(QWidget *Mayo__WidgetModelTree)
    {
        if (Mayo__WidgetModelTree->objectName().isEmpty())
            Mayo__WidgetModelTree->setObjectName("Mayo__WidgetModelTree");
        ...
        treeWidget_Model->setObjectName("treeWidget_Model");
    ...
    {
        Mayo__WidgetModelTree->setWindowTitle(QCoreApplication::translate("Mayo::WidgetModelTree", "Form", nullptr));
    } // retranslateUi
